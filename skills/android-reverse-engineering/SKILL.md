...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/check-deps.sh
```

On Windows (PowerShell):
```powershell
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/check-deps.ps1"
```

If anything is missing, follow the installation instructions in `/Users/arsh/.agents/skills/android-reverse-engineering/references/setup-guide.md`.
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/fingerprint.sh <file.apk|file.xapk>
```
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/install-dep.sh <dep>
```

On Windows (PowerShell):
```powershell
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/install-dep.ps1" <dep>
```
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/decompile.sh [OPTIONS] <file>
```

On Windows (PowerShell):
```powershell
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/decompile.ps1" [OPTIONS] <file>
```
...
See `/Users/arsh/.agents/skills/android-reverse-engineering/references/jadx-usage.md` and `/Users/arsh/.agents/skills/android-reverse-engineering/references/fernflower-usage.md` for the full CLI references.
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/recover-kotlin-names.sh \
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/lookup-name.sh \
...
See `/Users/arsh/.agents/skills/android-reverse-engineering/references/kotlin-name-recovery.md`
...
See `/Users/arsh/.agents/skills/android-reverse-engineering/references/call-flow-analysis.md` for detailed techniques and grep commands.
...
```bash
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/
```

On Windows (PowerShell):
```powershell
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.ps1" <output>/sources/
```

Targeted searches:
```bash
# Only Retrofit
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --retrofit

# Only hardcoded URLs
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --urls

# Only auth patterns
bash /Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --auth
```

On Windows (PowerShell):
```powershell
# Only Retrofit
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.ps1" <output>/sources/ -Retrofit

# Only hardcoded URLs
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.ps1" <output>/sources/ -Urls

# Only auth patterns
& "/Users/arsh/.agents/skills/android-reverse-engineering/scripts/find-api-calls.ps1" <output>/sources/ -Auth
```
...
See `/Users/arsh/.agents/skills/android-reverse-engineering/references/api-extraction-patterns.md` for library-specific search patterns and the full documentation template.
...
- `/Users/arsh/.agents/skills/android-reverse-engineering/references/setup-guide.md` — Installing Java, jadx, Fernflower/Vineflower, dex2jar, and optional tools
- `/Users/arsh/.agents/skills/android-reverse-engineering/references/jadx-usage.md` — jadx CLI options and workflows
- `/Users/arsh/.agents/skills/android-reverse-engineering/references/fernflower-usage.md` — Fernflower/Vineflower CLI options, when to use, APK workflow
- `/Users/arsh/.agents/skills/android-reverse-engineering/references/api-extraction-patterns.md` — Library-specific search patterns and documentation template
- `/Users/arsh/.agents/skills/android-reverse-engineering/references/call-flow-analysis.md` — Techniques for tracing call flows in decompiled code
